...
public class GameController : MonoBehaviour
{
    ...
    [SerializeField] UnityEngine.UI.Text Scoreboard, TimerText, Scorer, BounceIndicator, ScoreIndicator, TimeIndicator, RadiusIndicator, SpeedIndicator;
